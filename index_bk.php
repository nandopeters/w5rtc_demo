...
<li><a class="scroll" data-speed="2000" data-easing="easeOutQuad" href="#destination5" onClick="update_content('contactus'); return false;" id="contactus">Contact Us</a></li>
            ...
            <div class="searchaligndiv fr">
                    ...
                    <div class="tpaddingdiv1">
                    <div class="textalignleftdiv fl"><a href="#"><img src="image/signin.png" border="0" name="w5rtc" id="activator" /></a></div><div class="textalignrightdiv fr"><button id="showTop" class="buttondivone"><img src="image/icon.png" border="0" name="w5rtc" /></button></div>
                    <div class="clear"></div>
                    </div>
            </div>
            <div class="clear">
...
<div class="row">
	<div class="allsidepadding">
    	<div class="bpaddingdiv1">
            ...
            <div class="large-4 fl textaligncenterdiv bpaddingdiv3">
                <div class="wfiveallimage"><a href="w5desi/index.html"><img src="image/w5desi.png" border="0" name="w5rtc" class="span2" /></a></div>
            </div>
        </div>
        <div class="clear">
        </div>
...
<div class="allsidepadding">
	<div class="large-12 marginautodiv">
    	<!--1st_div-->
        	...
        	<div class="allpaddingdiv2">
                ...
                <div class="tbpaddingdiv1 textaligncenterdiv">
                    ...
                    <div class="bpaddingdiv1"><input id="user_name" class="input-text text large-11" type="text" tabindex="5" placeholder="User Name" name="user[name]" style="background-color:#FFF;"></div>
                    <div class="bpaddingdiv1"><input id="user_name" class="input-text password large-11" type="password" tabindex="5" placeholder="Password" name="user[password]" style="background-color:#FFF;"></div>
                    </div>
                    <div class="tbpaddingdiv1 allsidepaddingleftright"><div class="allsidedivpadding"><input class="buttonsarfondiv submit large-12" type="submit" value="Sign in" name="submit"></div></div>
                    ...
                    <div class="fontssizediv colorblack">
                    	Sign in with <span class="colorgreen fontweightbolddiv fontstyleitalicdiv"><a href="#">Facebook</a></span> or <span class="colorgreen fontweightbolddiv fontstyleitalicdiv"><a href="#">Linkedin</a></span> or <span class="colorgreen fontweightbolddiv fontstyleitalicdiv"><a href="#">Google</a></span>
                    </div>
        ...
        <!--2nd_div-->
		<form name="frmsign" id="frmsign" action="" method="post" enctype="multipart/form-data">
        <div class="bgcolorwhite greenboxshadow borderradiusdiv2 bordergray" id="hiddenid" style="display:none; height:440px;">
					<span class="fr textalignrightdiv positionabsolute rightsidediv" style="margin:-5px -5px 0px 0px">
                    	<a href="#"><img src="image/closebtn.png" border="0" name="boxclose1" id="boxclose1"></a>
                    </span>
           ...
           <div class="allpaddingtopdiv">         
                <div class="tbpaddingdiv1 textaligncenterdiv">
                    ...
                    <a onClick="$('#newfile').click();" href="#" class="displaydivnone"><img src="image/videocam1.png" border="0" name="folder" id="snaptwo" class="snapwidth"></a>
                     ...
                     <div class="tpaddingdiv2">
                            ...
                            <input type="text" id="subfile" name="subfile" class="input-xlarge" style="display:none;">
                    	<div class="textaligncenterdiv"><a onClick="$('#pdffile').click();" href="#"><img src="image/uploadphoto.png" border="0" name="folder" class="snapwidth"></a></div>
                    </div>
                </div>
                </div>
                ...
                <div class="textaligncenterdiv">
                    ...
                    <div class="bpaddingdiv1"><input id="lastname" class="input-text text large-11" type="text" tabindex="5" placeholder="Last Name" name="lastname" style="background-color:#FFF;"></div>
...
<span class="fontweightbolddiv fontssizediv colorgreen">Abinash Ghosh</span>
                        </div>
                        <div>
                        <span class="fontweightbolddiv fontssizediv colorblack ">W5 ID</span><br>
<span class="fontweightbolddiv fontssizediv colorgreen">abinashghosh2001</span>
                        </div>
	                </div>
...
function finalval()
{
			...
			else
			{
				...
				document.frmsign.action="innersign.php";
